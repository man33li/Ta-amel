      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Start organizing your thoughts with MindForge
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          >
            {loading ? <><Spinner size="sm" className="inline mr-2" /> Creating account...</> : 'Sign up'}
          </button>
        </form>
        ...
        <button
          ...
          type="button"
          className="w-full py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-3"
        >
